...
export class Init1691346614797 implements MigrationInterface {
    name = 'Init1691346614797'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderSource" integer NOT NULL, "loyaltyMemberId" character varying NOT NULL, "orderStatus" integer NOT NULL, "location" integer NOT NULL, "createdBy" character varying NOT NULL, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "line_item" ("id" character varying NOT NULL, "itemType" integer NOT NULL, "name" character varying NOT NULL, "price" integer NOT NULL, "itemStatus" integer NOT NULL, "isBaristaOrder" boolean NOT NULL, "orderId" uuid, CONSTRAINT "PK_cce6b13e67fa506d1d9618ac68b" PRIMARY KEY ("id"))`);
