...
export class Init1691424890103 implements MigrationInterface {
    name = 'Init1691424890103'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "barista_item" ("id" uuid NOT NULL, "itemType" integer NOT NULL, "itemName" character varying NOT NULL, "timeIn" TIMESTAMP NOT NULL, "timeUp" TIMESTAMP NOT NULL, CONSTRAINT "PK_d2fcdb499431fc4f97da952dd68" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order" ("id" uuid NOT NULL, "orderSource" integer NOT NULL, "loyaltyMemberId" character varying NOT NULL, "orderStatus" integer NOT NULL, "location" integer NOT NULL, "createdBy" character varying NOT NULL, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "line_item" ("id" uuid NOT NULL, "itemType" integer NOT NULL, "name" character varying NOT NULL, "price" double precision NOT NULL, "itemStatus" integer NOT NULL, "isBaristaOrder" boolean NOT NULL, "orderId" uuid, CONSTRAINT "PK_cce6b13e67fa506d1d9618ac68b" PRIMARY KEY ("id"))`);
